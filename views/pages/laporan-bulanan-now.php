...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <head>
    ...
    <title>Laporan Bulanan NOW</title>
  </head>
...
<?php
    ...
    $tglstkak = $laporanBulananNow->ambilTgl($idsub);
?>
    <div class="box box-info">
      <div class="box-header with-border">
        <h3 class="box-title"> Tanggal Stok OPNAME NOW</h3>
      ...
      <!-- /.box-header -->
      <!-- form start -->
      <form method="post" enctype="multipart/form-data" name="form1" class="form-horizontal" id="form1" action="input-laporan-bulanan/">
        <div class="box-body">
        ...
        <table id="example2" class="table table-bordered table-hover display nowrap" width="100%">
          ...
          <tbody>
            <?php
                $col = 0;
                $no  = 1;
                foreach ($laporanBulananNow->tampildata($idsub) as $rowd) {
